...
_velocity_dec = [import_state.reactive], _initial_dec = [import_state.reactive], _previous_dec = [import_state.reactive], _current_dec = [import_state.reactive], _delta_dec = [import_state.derived], _direction_dec = [import_state.derived];
var Position = class {
