...
render_fn = function() {
  ...
  dropEffectCleanup = effect(() => {
    if (dragOperation.status.dropped) {
      ...
      if (!translate2 || (options == null ? void 0 : options.disableDropAnimation)) {
