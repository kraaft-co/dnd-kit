import { untracked, effect, reactive, signal, effects, derived, computed, deepEqual, batch } from '@dnd-kit/state';
      ...
      const end = () => {
        manager.renderer.rendering.then(() => {
          ...
          const dropping = untracked(() => {
            var _a;
            return ((_a = source.value) == null ? void 0 : _a.status) === "dropping";
          });
          if (dropping) {
